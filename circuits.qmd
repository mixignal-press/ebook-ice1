...
$$ v_{TH} = \left[{\frac{R_2}{R_1+R_2}}\right]v_S + \left[{\frac{R_1R_2}{R_1+R_2}}\right]i_S$$,

and the Thevenin, and Norton, resistance can be calculated by shorting independent voltage source and opening independent current sources results in 

$$ R_{TH} = R_1 || R_2 = \frac{R_1 R_2}{R_1 + R_2}$$

The Norton short-circuit current can be shown to be

$$i_{N} = \frac{v_S}{R_1} + i_S$$
